...
//		driver.quit();
	...
	private static AndroidDriver<MobileElement> startAndroid() {
		...
		//capabilities.setCapability(MobileCapabilityType.APP, "D:\MyDoc\Rabota\Automat\android_apidemos_Vira_Tarkovska\ApiDemos-debug.apk");
		capabilities.setCapability(MobileCapabilityType.APP, appPath());
		capabilities.setCapability(AndroidMobileCapabilityType.AVD, "Nexus_6_API_22");
